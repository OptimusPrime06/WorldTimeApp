...
abstract class SelectCountryViewModelMiddleWare {
  ...
  WorldTimeUseCaseMiddleWare get useCase;
...
class SelectCountryViewModel extends SelectCountryViewModelMiddleWare {
  ...
  @override
  final WorldTimeUseCaseMiddleWare useCase; // World Time Use Case
  ...
  Future<CityEntity> getTimeFor(CountryEntity city) async { //Get city time
    ...
    final cityData = CityEntity.mapFromWorldModel(await useCase.getWorldTimeWith(url), city.cityName);
    return cityData;
  }
